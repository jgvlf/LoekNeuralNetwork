inputs: list[tuple[float]] = [(0.0000, 0.3929), (0.5484, 0.7500), (0.0645, 0.5714), (0.5806, 0.5714),
...
purple: tuple[int, int, int] = (1, 0, 0)
orange: tuple[int, int, int] = (0, 1, 0)
green: tuple[int, int, int] = (0, 0, 1)

targets: list[tuple[int, int, int]] = [purple, orange, purple, orange, green, purple, purple, green, orange,
...
test_inputs: list[tuple[float]] = [(0.0000, 0.3929), (0.0645, 0.5714), (0.0968, 0.3214),
...
test_targets: list[tuple[int, int, int]] = [purple, purple, purple, purple, purple, purple, purple, purple,
                                            purple, purple, orange, orange, orange, orange, orange, orange, orange,
                                            orange,
                                            orange, orange, green, green, green, green, green, green, green, green,
                                            green, green]
