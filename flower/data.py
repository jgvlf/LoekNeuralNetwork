inputs: list[tuple[float]] = [(0.0000, 0.0000), (0.2778, 0.2500), (0.2778, 0.9375), (0.9167, 0.6563),
...
red: tuple[int, int, int] = (1, 0, 0)
green: tuple[int, int, int] = (0, 1, 0)
blue: tuple[int, int, int] = (0, 0, 1)

targets: list[tuple[int, int, int]] = [red, red, blue, green, red, red, red, green, red, green, blue, green, red,
